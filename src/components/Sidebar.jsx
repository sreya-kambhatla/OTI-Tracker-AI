...
function ResetIcon() {
  return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.75"/></svg>;
}
function SunIcon() {
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-footer">
        ...
        <button className="sidebar-action" onClick={onImport}>
        ...
        <button className="sidebar-action danger" onClick={onReset}>
